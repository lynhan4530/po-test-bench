<!-- token-count: ~520 | last-checked: 2026-05 -->
...
Fill in all sections using the blueprint and document state. Apply the `generatorInstruction` to control quality, completeness, and consistency across all sections.
